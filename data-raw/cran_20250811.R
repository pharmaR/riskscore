#############
## code to prepare `cran_20250811` dataset
...
incrmt_cran <- function(pkg_names, label) {
  ...
  saveRDS(cran_assessed_20250811, paste0("data/cran_assessed_20250811_",label,".rds"))
  ...
  saveRDS(cran_scored_20250811, paste0("data/cran_scored_20250811_",label,".rds"))
  cat("\n--> batch", label, "saved.\n\n")
}
